...
extern Buffer<DWARFDebugFileEntry> fileEntryTable;
...
int main(){
    ...
    if(!compilationUnits.capacity){
        ERROR("Something went wrong with reading the .debug_info sectiom, exiting.\n");
        // clear enviroment
        return 1;
    }
    
    debugArangesSectionParse(&file, sections, &compilationUnits);
